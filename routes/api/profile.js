...
// @desc    Delete experience in user profile by experience ID
// @access  Private
...
// @desc    Delete education in user profile by education ID
// @access  Private
  ...
  try {
    ...
    request(options, (error, response, body) => {
      ...
      if (response.statusCode !== 200) {
        return res.status(404).json({ msg: options.uri });
      }
